  ...
  return (
    <div className="flex h-full flex-col">
      <header className="border-b border-slate-800 bg-slate-900/80 px-4 py-3">
        <h1 className="text-lg font-semibold text-white">Adoption Adjudicator</h1>
        <p className="text-xs text-slate-400">Confirm textbook-adoption events against their sources — offline.</p>
      </header>
      <div className="p-4">
        <div className="mb-4 rounded-xl border border-slate-800 bg-slate-900/40 p-3 text-sm text-slate-300">
          ...
          the adoption dataset builder. After the first import it works fully offline.
        </div>
        <Settings embedded />
      </div>
    </div>

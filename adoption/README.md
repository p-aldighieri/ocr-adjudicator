...
sample). **Real dataset** (424 items from the 2026-08-07 adoption master, incl. Kentucky + title-campaign matches, 328 MB):
[`adoption-dataset.zip`](https://github.com/p-aldighieri/ocr-adjudicator/releases/download/adoption-dataset-v3/adoption-dataset.zip)
